...
<!-- Main Menu and Submenu End -->
 ...
 <div class="contentBg">
	...
	<div>
	  ...
	  <input type="button" id="edit_reset" value="Reset" class="tblbtn" title="Reset" name="" onmouseover="this.className = 'tblbtnHover'" onmouseout="this.className = 'tblbtn'" onclick="doRedirect();">
	</div>
	<!--Button End-->
	</form>
   </div>
