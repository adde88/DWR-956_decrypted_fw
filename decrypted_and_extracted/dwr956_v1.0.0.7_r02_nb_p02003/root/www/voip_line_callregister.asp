    ...
    <body class="decBackgroundDef">
        <div id="tabContainer">
            ...
            <ul id="tabInv">
				...
				<li><a href=
                "voip_line_callregister.asp" class="selected"><span>Call Register</span></a></li>
				<li><a href=
		...
		<br>
         ...
         <span class="textTitle"><%ifx_get_voip_sip_linestate("LineNo");%> &gt; Call Register</span>
        <div align="center">
<FORM ACTION="/goform/ifx_set_voip_sip_cr" METHOD="POST" NAME="call_reg">
<input type="hidden" name="page" value="voip_line_callregister.asp">
