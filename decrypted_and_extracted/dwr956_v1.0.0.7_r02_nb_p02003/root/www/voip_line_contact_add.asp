...
<script type="text/javascript">
  ...
  var contactNumber2=document.contact.contactnum2.value;
    ...
    <body class="decBackgroundDef">
        <div>
            <span class="textTitle"><%ifx_get_voip_sip_linestate("LineNo");%> &gt; Add Contact </span>
        </div>
        <br/>
	...
	<input type="hidden" name="userlevel" value=<%ifx_get_currentUser_authority();%>>
		...
		<tr><td>Last-Name</th ><Td align="left"> <Input type="text" maxlength="31" name="lastname" value=""> </td> </TR> 
