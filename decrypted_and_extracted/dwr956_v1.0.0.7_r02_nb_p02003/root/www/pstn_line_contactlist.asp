...
var maxLineEntires=0,currentLineEntries=0, currentCommonEntries=0,maxCommonEntries=0;
...
function addNewContact()
{
  ...
  document.contact.page.value="pstn_line_contact_add.asp";
	document.contact.submit();
  return true; 
}
...
function editContactEntry(){
  ...
  document.contact.deleteall.value=0;
  document.contact.deleteentry.value=0;
  document.contact.page.value="pstn_line_contact_edit.asp";
  ...
  return true;
    ...
    <body class="decBackgroundDef">
		...
		<br>
         ...
         <span class="textTitle"><%ifx_get_voip_sip_pstn("pstn_name")%> &gt; Contact List</span>
        <div align="center">
