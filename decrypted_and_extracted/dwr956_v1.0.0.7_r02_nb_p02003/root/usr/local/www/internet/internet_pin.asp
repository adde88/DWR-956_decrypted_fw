...
function enterPinValidate(Ele)
{
    ...
    if (PinCode.length < 4 || !pin_puk_rule.test(PinCode)) {
 	    alert(gettext("Enter PIN: Please enter 4-8 digits."));
 	    return false;
    }
	  	return true;
   ...
   if (PukCode.length < 8 || !pin_puk_rule.test(PukCode)) {
     ...
     alert(gettext("Enter New PIN: Please enter 4-8 digits."));
     return false;
   }

			if (ReNewPinCode.length < 4 || !pin_puk_rule.test(ReNewPinCode)) {
      alert(gettext("Enter Confirm New PIN: Please enter 4-8 digits."));
      return false;
   }
...
<div class="contentBg">
  ...
  <table cellspacing="0" class="configTbl">
   <tr>
     ...
     <td><input type="password" name="lte_pin" id="txtPin" maxlength="8" onkeypress="return onkeypress_number_only(event);" class="configF1" /></td>
   </tr>
   <tr>
     <td colspan="2">
  ...
  <table cellspacing="0" class="configTbl">
   ...
   <tr>
     ...
     <td><input type="password" name="lte_pin" id="NewPin" maxlength="8" onkeypress="return onkeypress_number_only(event);" class="configF1" /></td>
   </tr>
   <tr>
     <td><script>document.write(gettext("Confirm New PIN"));</script></td>
     <td><input type="password" id="ReNewPin" maxlength="8" onkeypress="return onkeypress_number_only(event);" class="configF1" /></td>
   </tr>
   <tr>
     <td colspan="2">
