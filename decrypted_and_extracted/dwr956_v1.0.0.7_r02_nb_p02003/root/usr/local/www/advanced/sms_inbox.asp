...
<!-- Right Content start -->
<div id="content_all">
    <div id="content_bg01"><script>document.write(gettext("SMS Inbox"));</script></div>
	<div id="content_bg02">
    
	<div id="get_sms_inbox_info">  
	  <input type="button" value="Delete All" class="submit_s" id="inbox_delete_all" name="inbox_delete_all" style="margin:5px 10px 5px 20px" />
	  <span id="short_inbox_total_num"></span>/250
	  <table class="listable" border="0" cellpadding="0" cellspacing="0" style="margin:0 0 40px 20px; width:680px;">
	    <tr>
	      ...
	      <th width="100"><script>document.write(gettext("From / Time"));</script></th>
