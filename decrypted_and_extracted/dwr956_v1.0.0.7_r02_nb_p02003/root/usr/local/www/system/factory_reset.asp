...
{
	var factrst = confirm(gettext("The device is being reset to Factory Settings. All your configuration will be lost.\n") + gettext("Click OK to continue else click Cancel to abort"));
