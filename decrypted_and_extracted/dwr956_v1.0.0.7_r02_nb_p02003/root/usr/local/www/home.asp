...
function InternetInfoDisplay2(NwInfoArr)
{
 ...
 if (radio_interference == "GSM") {
  wan_network_type = "wan_network_type_2g";
   ...
   } else if (signal_level == "4" || signal_level == "3" || signal_level == "2") {
...
function getInternetInfo()
{
 ...
 InternetInfoDisplay2(NwInfoArr2);
					...
					<tr><td class="home_wifi_table_icon" valign="top"><a href="../wifi/wifi_clientlist.asp"><img src="../images/home/Home_WiFiIcon.png" border="0" /></a></td>
						<td class="home_internet_table_content_background">
							<ul class="home_content_internet_list">
								...
								<li>&nbsp;</li>
								<li><span class="home_content_list_title"><script>document.write(gettext("Channel 11n"));</script>: </span><span class="home_content_list_text" id="wifi_channel_11n"></span></li>
								<li><span class="home_content_list_title"><script>document.write(gettext("Channel 11ac"));</script>: </span><span class="home_content_list_text" id="wifi_channel_11ac"></span></li>
  ...
  if (ajax.readyState == 4)
   ...
   if (ajax.status == 200)
    ...
    if (data)
      ...
      InternetInfoDisplay2(result[1].split("#"));
