 ...
 <div class="contentBg">
    ...
    <table cellspacing="0" id="WiFissidEditTable" class="configTbl">
      <tr>
        ...
        <td><input type="checkbox" name="scheduleStatus" id="scheduleStatus"></td>
	  </tr>
	  <tr>
	...
	<div>
	  ...
	  <input type="submit" id="edit_reset" value="Reset" class="tblbtn" title="Reset" name="" onmouseover="this.className = 'tblbtnHover'" onmouseout="this.className = 'tblbtn'" onclick="doRedirect();">
	</div>
	<!--Button End-->
	</form>
   </div>
