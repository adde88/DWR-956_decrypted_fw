    ...
    if (ajax.readyState == 4){
      if (ajax.status == 200) {
        ...
        else
		{
          if (result == 201)
		  {
            document.getElementById("mdm_message").style.display=" Error: Unknown product ID. Please contact your service provider."; 
          }
		  else if (result == 202)
		  {
            document.getElementById("mdm_message").style.display="Error: Download failed. Please contact your service provider.";
            
          }
		  else if (result == 203)
		  {
            document.getElementById("mdm_message").style.display="Error: Unknown upgrade failed. Please contact your service provider.";
          }
		  else if (result == 105)
		  {
		  	document.getElementById("mdm_message").style.display="Error: Cannot open upgrade file. Please try again or contact your service provider.";
		  }
        }
      }
    }
