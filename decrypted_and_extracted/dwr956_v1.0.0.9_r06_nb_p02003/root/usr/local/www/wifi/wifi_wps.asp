...
<div class="contentBg">
  ...
  <div class="secInfo"><br><script>document.write(gettext("WPS is a standard for easy and secure setup of a wireless connection. In this section you can enable WPS for a client connection using OPEN/WPA/WPA2 security."));</script><br></div>
