  ...
  <ul>
    ...
    <li class="leftbu"><a href="sms_newsms.asp">Short Message</a>
     <dl>
       ...
       <dd class="ddbuhover">SMS on SIM Card</dd>
...
<!-- Right Content start -->
<div id="content_all">
  <div id="content_bg01"><script>document.write( gettext("SMS on SIM Card") );</script></div>
  <div id="content_bg02">

  <div id="get_sim_sms_info">  
	  <input type="button" id="short_sms_delete_all" value="Delete All" class="submit_s" style="margin:5px 10px 5px 20px" />
	  <span id="short_sms_total_num"></span><!--/<span id="short_sms_max_num"></span>-->
	    ...
	    <tr>
	      ...
	      <th width="120"><script>document.write( gettext("From / Time") );</script></th>
