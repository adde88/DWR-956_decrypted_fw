	...
	<table cellspacing="0" id="tblWiFiSetting" width="720px" style="table-layout: fixed;" class="specTbl">
      <tr>
		...
		<td class="tdH" width="4%"><input type="hidden" name="imgSelectAllChk" id="imgSelectAll" title="Select All" onclick="secChkBoxSelectOrUnselectAll ('tblWiFiSetting', this)"></td-->
      	<td class="tdH" width="10%">Status</td>
      	<td class="tdH" width="22%">SSID</td>
      	<td class="tdH" width="11%">Frequence</td>
      	<td class="tdH" width="11%">Broadcast</td>
      	<td class="tdH" width="12%">Security</td>
      	<td class="tdH" width="10%">Active<br>Time</td>
      	<td class="tdH" width="10%">Start<br>Time</td>
      	<td class="tdH" width="11%">Stop<br>Time</td>
      </tr>
      <%getWiFiAP();%>
    </table>  
  	<!--Button Start-->
