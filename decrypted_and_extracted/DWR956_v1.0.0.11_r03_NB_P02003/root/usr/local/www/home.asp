...
function InternetInfoDisplay1(NwInfoArr)
{
 //Internet: Carrier
   ...
   document.getElementById("wan_carrier").innerHTML="None";
 }
 ...
 if (NwInfoArr[0] == "Registered") {
   if (NwInfoArr[1] == "Roaming") {
     ...
     document.getElementById("wan_roaming").innerHTML="None";
   }
 } else {
   document.getElementById("wan_roaming").innerHTML="None";
 }
...
function InternetInfoDisplay2(NwInfoArr, NatMode, RegisterStatus)
{
 ...
 if (RegisterStatus == "Registered") {
   if (radio_interference == "GSM") {
     document.getElementById("wan_network_type_2g").src="../images/home/Home_Internet_BlueCircle.png";
   } else if (radio_interference == "UMTS") {
     document.getElementById("wan_network_type_3g").src="../images/home/Home_Internet_GreenCircle.png";
					...
					<tr>
						...
						<td class="home_internet_table_content_background">
							<ul class="home_content_internet_list">
								<li><img src="../images/home/Signal_0.png" border="0" id="signal" /><span style="font-size: 18pt;" id="percent"></span></li>
